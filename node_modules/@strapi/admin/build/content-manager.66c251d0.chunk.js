...
`)),a.mime.includes("image")?e.current.replaceSelection(`![${a.alt}](${a.url})`):e.current.replaceSelection(`[${a.alt}](${a.url})`)}),setTimeout(()=>e.current.focus(),0)},Qp=(e,t,n,s,a)=>{const l=Ms(t,a),i=e.current.getRange({line:n+1,ch:0},{line:1/0,ch:1/0});if(e.current.replaceRange("",{line:n+1,ch:0},{line:1/0,ch:1/0}),e.current.replaceSelection(""),e.current.setCursor({line:n,ch:s}),e.current.replaceSelection(`
...
`;var qm=Object.defineProperty,As=Object.getOwnPropertySymbols,Wm=Object.prototype.hasOwnProperty,zm=Object.prototype.propertyIsEnumerable,js=(e,t,n)=>t in e?qm(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,Hn=(e,t)=>{for(var n in t||(t={}))Wm.call(t,n)&&js(e,n,t[n]);if(As)for(var n of As(t))zm.call(t,n)&&js(e,n,t[n]);return e},$s=(e,t,n)=>new Promise((s,a)=>{var l=c=>{try{u(n.next(c))}catch(d){a(d)}},i=c=>{try{u(n.throw(c))}catch(d){a(d)}},u=c=>c.done?s(c.value):Promise.resolve(c.value).then(l,i);u((n=n.apply(e,t)).next())});const _n=({attribute:e,contentTypeUID:t,description:n,disabled:s,error:a,intlLabel:l,labelAction:i,name:u,onChange:c,value:d,placeholder:m,required:f})=>{const{modifiedData:y,initialData:h,layout:b}=(0,g.useCMEditViewDataManager)(),[E,F]=(0,r.useState)(!1),[C,P]=(0,r.useState)(null),I=ks(d,300),R=(0,r.useRef)(),z=h[u],{formatMessage:M}=(0,A.useIntl)(),V=T()(b,["options","timestamps",0]),B=!h[V],G=ks(y[e.targetField],300),[U,q]=(0,r.useState)(!1),[x,Z]=(0,r.useState)(null),W=l.id?M({id:l.id,defaultMessage:l.defaultMessage},Hn({},l.values)):u,X=n?M({id:n.id,defaultMessage:n.defaultMessage},Hn({},n.values)):"",w=m?M({id:m.id,defaultMessage:m.defaultMessage},Hn({},m.values)):"";R.current=(O=!1)=>$s(void 0,null,function*(){F(!0);const _=ve("uid/generate");try{const{data:{data:K}}=yield ge.be.post(_,{contentTypeUID:t,field:u,data:y});c({target:{name:u,value:K,type:"text"}},O),F(!1)}catch(K){F(!1)}});const $=()=>$s(void 0,null,function*(){F(!0);const O=ve("uid/check-availability");if(!!d)try{const{data:_}=yield ge.be.post(O,{contentTypeUID:t,field:u,value:d?d.trim():""});P(_),F(!1)}catch(_){F(!1)}});(0,r.useEffect)(()=>{!d&&e.required&&R.current(!0)},[]),(0,r.useEffect)(()=>{I&&I.trim().match(jm)&&I!==z&&$(),I||P(null)},[I,z]),(0,r.useEffect)(()=>{let O;return C&&C.isAvailable&&(O=setTimeout(()=>{P(null)},4e3)),()=>{O&&clearTimeout(O)}},[C]),(0,r.useEffect)(()=>{!U&&B&&G&&y[e.targetField]&&!d&&R.current(!0)},[G,U,B]);const Y=()=>{Z(M({id:"content-manager.components.uid.regenerate",defaultMessage:"Regenerate"}))},Q=()=>{Z(null)},S=O=>{O.target.value&&B&&q(!0),c(O)};return r.createElement(zn.TextInput,{disabled:s,error:a,endAction:r.createElement($m,null,C&&C.isAvailable&&!x&&r.createElement(Un,{alignItems:"center",justifyContent:"flex-end"},r.createElement(Lm(),null),r.createElement(L.Typography,{textColor:"success600",variant:"pi"},M({id:"content-manager.components.uid.available",defaultMessage:"Available"}))),C&&!C.isAvailable&&!x&&r.createElement(Un,{notAvailable:!0,alignItems:"center",justifyContent:"flex-end"},r.createElement(Tt(),null),r.createElement(L.Typography,{textColor:"danger600",variant:"pi"},M({id:"content-manager.components.uid.unavailable",defaultMessage:"Unavailable"}))),x&&r.createElement(Un,{alignItems:"center",justifyContent:"flex-end"},r.createElement(L.Typography,{textColor:"primary600",variant:"pi"},x)),r.createElement(Bm,{onClick:()=>R.current(),label:"regenerate",onMouseEnter:Y,onMouseLeave:Q},E?r.createElement(Vm,null,r.createElement(Am(),null)):r.createElement(Sm(),null))),hint:X,label:W,labelAction:i,name:u,onChange:S,placeholder:w,value:d||"",required:f})};_n.propTypes={attribute:o().shape({targetField:o().string,required:o().bool}).isRequired,contentTypeUID:o().string.isRequired,description:o().shape({id:o().string.isRequired,defaultMessage:o().string.isRequired,values:o().object}),disabled:o().bool,error:o().string,intlLabel:o().shape({id:o().string.isRequired,defaultMessage:o().string.isRequired,values:o().object}).isRequired,labelAction:o().element,name:o().string.isRequired,onChange:o().func.isRequired,value:o().string,placeholder:o().shape({id:o().string.isRequired,defaultMessage:o().string.isRequired,values:o().object}),required:o().bool},_n.defaultProps={description:void 0,disabled:!1,error:void 0,labelAction:void 0,placeholder:void 0,value:"",required:!1};const Um=_n;var Hm=p(28611),_m=p.n(Hm),Gm=p(77236),Bs=p.n(Gm),Zm=p(86834),Re=p.n(Zm),Qm=p(3040),re=p.n(Qm);const Km=(0,k.default)(D.Box)`
  svg path {
    fill: ${({theme:e})=>e.colors.neutral500};
  }
...
`,ir=({componentFieldName:e,hasErrorMessage:t,hasErrors:n,isDraggingSibling:s,isOpen:a,isReadOnly:l,onClickToggle:i,schema:u,toggleCollapses:c,moveComponentField:d,removeRepeatableField:m,setIsDraggingSibling:f,triggerFormValidation:y,displayedValue:h})=>{const b=(0,r.useRef)(null),E=(0,r.useRef)(null),[,F]=(0,r.useState)(!1),{formatMessage:C}=(0,A.useIntl)(),P=u.layouts.edit,[,I]=(0,Te.useDrop)({accept:Oe.COMPONENT,canDrop(){return!1},hover(U,q){if(!E.current)return;const x=U.originalPath,Z=e,W=x.split("."),X=W.slice().splice(-1).join(""),w=Z.split(".").splice(-1).join(""),$=W.slice(0,W.length-1),Y=parseInt(X,10),Q=parseInt(w,10);if(Y===Q)return;const S=E.current.getBoundingClientRect(),O=(S.bottom-S.top)/2,K=q.getClientOffset().y-S.top;Y<Q&&K<O||Y>Q&&K>O||x.split(".").length===Z.split(".").length&&(d($,Y,Q),U.originalPath=Z)}}),[{isDragging:R},z,M]=(0,Te.useDrag)({type:Oe.COMPONENT,item(){return c(-1),{displayedValue:h,originalPath:e}},end(){y(),f(!1)},collect:U=>({isDragging:U.isDragging()})});(0,r.useEffect)(()=>{M((0,Kt.rX)(),{captureDraggingState:!1})},[M]),(0,r.useEffect)(()=>{R&&f(!0)},[R,f]),(0,r.useEffect)(()=>{s||F(U=>!U)},[s]);const V={dragRef:z(b),dropRef:I(E)},B=pa()(h),G=n?"error":void 0;return r.createElement(D.Box,{ref:V?V.dropRef:null},R&&r.createElement(mg,null),!R&&s&&r.createElement(bg,{displayedValue:B,componentFieldName:e}),!R&&!s&&r.createElement(ze.Accordion,{error:G,hasErrorMessage:t,expanded:a,onToggle:i,id:e,size:"S"},r.createElement(ze.AccordionToggle,{action:l?null:r.createElement(se.Stack,{horizontal:!0,spacing:0},r.createElement(gg,{expanded:a,noBorder:!0,onClick:()=>{m(e),c()},label:C({id:v("containers.Edit.delete"),defaultMessage:"Delete"}),icon:r.createElement(Be(),null)}),r.createElement(ar.Tooltip,{description:C({id:v("components.DragHandle-label"),defaultMessage:"Drag"})},r.createElement(Tg,{role:"button",tabIndex:-1,ref:V.dragRef,onClick:U=>U.stopPropagation()},r.createElement(Xe(),null)))),title:B,togglePosition:"left"}),r.createElement(ze.AccordionContent,null,r.createElement(se.Stack,{background:"neutral100",padding:6,spacing:6},P.map((U,q)=>r.createElement(le.Grid,{gap:4,key:q},U.map(({name:x,fieldSchema:Z,metadatas:W,queryInfos:X,size:w})=>{const $=Z.type==="component",Y=`${e}.${x}`;if($){const Q=Z.component;return r.createElement(le.GridItem,{col:w,s:12,xs:12,key:x},r.createElement(Yt,{componentUid:Q,intlLabel:{id:W.label,defaultMessage:W.label},isRepeatable:Z.repeatable,isNested:!0,name:Y,max:Z.max,min:Z.min,required:Z.required}))}return r.createElement(le.GridItem,{key:Y,col:w,s:12,xs:12},r.createElement(or,{fieldSchema:Z,keys:Y,metadatas:W,queryInfos:X}))})))))))};ir.defaultProps={isDraggingSibling:!1,isOpen:!1,setIsDraggingSibling(){},toggleCollapses(){}},ir.propTypes={componentFieldName:o().string.isRequired,hasErrorMessage:o().bool.isRequired,hasErrors:o().bool.isRequired,isDraggingSibling:o().bool,isOpen:o().bool,isReadOnly:o().bool.isRequired,onClickToggle:o().func.isRequired,schema:o().object.isRequired,toggleCollapses:o().func,moveComponentField:o().func.isRequired,removeRepeatableField:o().func.isRequired,setIsDraggingSibling:o().func,triggerFormValidation:o().func.isRequired,displayedValue:o().string.isRequired};const wg=(0,r.memo)(ir),Ig=Og(wg,Mg);var ba=p(87910),Dg=Object.defineProperty,Ea=Object.getOwnPropertySymbols,Sg=Object.prototype.hasOwnProperty,xg=Object.prototype.propertyIsEnumerable,va=(e,t,n)=>t in e?Dg(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,Lg=(e,t)=>{for(var n in t||(t={}))Sg.call(t,n)&&va(e,n,t[n]);if(Ea)for(var n of Ea(t))xg.call(t,n)&&va(e,n,t[n]);return e};const Fg=(0,k.default)(D.Box)`
  overflow: hidden;
...
`,$i=({components:e})=>{const{componentLayouts:t}=He();return r.createElement(se.Stack,{spacing:2,horizontal:!0,overflow:"scroll hidden",padding:3},e.map(n=>r.createElement(Wb,{hasRadius:!0,background:"neutral0",justifyContent:"center",alignItems:"center",height:`${84/16}rem`,minWidth:`${140/16}rem`,key:n,padding:2,direction:"column",borderColor:"neutral200",as:te.Link,to:`/content-manager/components/${n}/configurations/edit`},r.createElement(ji,{width:`${32/16}rem`,height:`${32/16}rem`,background:"neutral150",justifyContent:"center",alignItems:"center",padding:2},r.createElement(Dn.G,{icon:T()(t,[n,"info","icon"],"")})),r.createElement(D.Box,{paddingTop:1},r.createElement(L.Typography,{fontSize:1,textColor:"neutral600",fontWeight:"bold"},T()(t,[n,"info","displayName"],""))))))};$i.propTypes={components:o().arrayOf(o().string).isRequired};const zb=$i,Bi=(0,k.default)(Me.IconButton)`
  background-color: transparent;
  path {
    fill: ${({theme:e})=>e.colors.neutral600};
  }
...
`,$v=(0,k.default)(Jl)`
  max-width: ${32/16}rem;
`,Xl=({displayedFields:e,listRemainingFields:t,metadatas:n,onAddField:s,onClickEditField:a,onMoveField:l,onRemoveField:i})=>{const{formatMessage:u}=(0,A.useIntl)(),[c,d]=(0,r.useState)(!1),[m,f]=(0,r.useState)(null),y=(0,r.useRef)();function h(...E){f("add"),s(...E)}function b(...E){f("remove"),i(...E)}return(0,r.useEffect)(()=>{m==="add"&&(y==null?void 0:y.current)&&(y.current.scrollLeft=y.current.scrollWidth)},[e,m]),r.createElement(r.Fragment,null,r.createElement(D.Box,{paddingBottom:4},r.createElement(L.Typography,{variant:"delta",as:"h2"},u({id:v("containers.SettingPage.view"),defaultMessage:"View"}))),r.createElement(j.Flex,{paddingTop:4,paddingLeft:4,paddingRight:4,borderColor:"neutral300",borderStyle:"dashed",borderWidth:"1px",hasRadius:!0},r.createElement(jv,{size:"1",paddingBottom:4,ref:y},r.createElement(se.Stack,{horizontal:!0,spacing:3},e.map((E,F)=>r.createElement(Av,{key:E,index:F,isDraggingSibling:c,onMoveField:l,onClickEditField:a,onRemoveField:C=>b(C,F),name:E,labelField:n[E].list.label||E,setIsDraggingSibling:d})))),r.createElement($v,{size:"auto",paddingBottom:4},r.createElement(Ae.SimpleMenu,{label:u({id:v("components.FieldSelect.label"),defaultMessage:"Add a field"}),as:Me.IconButton,icon:r.createElement(ut(),null),disabled:t.length<=0,"data-testid":"add-field"},t.map(E=>r.createElement(Ae.MenuItem,{key:E,onClick:()=>h(E)},E))))))};Xl.propTypes={displayedFields:Se.PropTypes.array.isRequired,listRemainingFields:Se.PropTypes.array.isRequired,metadatas:Se.PropTypes.objectOf(Se.PropTypes.shape({list:Se.PropTypes.shape({label:Se.PropTypes.string})})).isRequired,onAddField:Se.PropTypes.func.isRequired,onClickEditField:Se.PropTypes.func.isRequired,onMoveField:Se.PropTypes.func.isRequired,onRemoveField:Se.PropTypes.func.isRequired};const Bv=Xl,Nv=(0,k.default)(j.Flex)`
  svg {
    width: ${32/16}rem;
    height: ${24/16}rem;
    margin-right: ${({theme:e})=>e.spaces[3]};
  }
`,ec=({attributes:e,fieldForm:t,fieldToEdit:n,onCloseModal:s,onChangeEditLabel:a,onSubmit:l,type:i})=>{const{formatMessage:u}=(0,A.useIntl)(),c=e[n].relationType;let d=!["media","relation"].includes(i);return["oneWay","oneToOne","manyToOne"].includes(c)&&(d=!0),r.createElement(Ge.ModalLayout,{onClose:s,labelledBy:"title"},r.createElement("form",{onSubmit:l},r.createElement(Ge.ModalHeader,null,r.createElement(Nv,null,r.createElement(_i,{type:i}),r.createElement(L.Typography,{fontWeight:"bold",textColor:"neutral800",as:"h2",id:"title"},u({id:v("containers.ListSettingsView.modal-form.edit-label"),defaultMessage:"Edit {fieldName}"},{fieldName:It()(n)})))),r.createElement(Ge.ModalBody,null,r.createElement(le.Grid,{gap:4},r.createElement(le.GridItem,{s:12,col:6},r.createElement(zn.TextInput,{id:"label-input",label:u({id:v("form.Input.label"),defaultMessage:"Label"}),name:"label",onChange:m=>a(m),value:t.label,hint:u({id:v("form.Input.label.inputDescription"),defaultMessage:"This value overrides the label displayed in the table's head"})})),d&&r.createElement(le.GridItem,{s:12,col:6},r.createElement(St.ToggleInput,{"data-testid":"Enable sort on this field",checked:t.sortable,label:u({id:v("form.Input.sort.field"),defaultMessage:"Enable sort on this field"}),name:"sortable",onChange:m=>a({target:{name:"sortable",value:m.target.checked}}),onLabel:u({id:"app.components.ToggleCheckbox.on-label",defaultMessage:"on"}),offLabel:u({id:"app.components.ToggleCheckbox.off-label",defaultMessage:"off"})})))),r.createElement(Ge.ModalFooter,{startActions:r.createElement(ye.Button,{onClick:s,variant:"tertiary"},u({id:"app.components.Button.cancel",defaultMessage:"Cancel"})),endActions:r.createElement(ye.Button,{type:"submit"},u({id:"global.finish",defaultMessage:"Finish"}))})))};ec.propTypes={attributes:o().objectOf(o().shape({relationType:o().string})).isRequired,fieldForm:o().shape({label:o().string,sortable:o().bool}).isRequired,fieldToEdit:o().string.isRequired,onChangeEditLabel:o().func.isRequired,onCloseModal:o().func.isRequired,onSubmit:o().func.isRequired,type:o().string.isRequired};const Vv=ec;var qv=Object.defineProperty,Wv=Object.defineProperties,zv=Object.getOwnPropertyDescriptors,tc=Object.getOwnPropertySymbols,Uv=Object.prototype.hasOwnProperty,Hv=Object.prototype.propertyIsEnumerable,nc=(e,t,n)=>t in e?qv(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,_v=(e,t)=>{for(var n in t||(t={}))Uv.call(t,n)&&nc(e,n,t[n]);if(tc)for(var n of tc(t))Hv.call(t,n)&&nc(e,n,t[n]);return e},Gv=(e,t)=>Wv(e,zv(t));const Zv=(e,t)=>Gv(_v({},e),{initialData:t,modifiedData:t}),Yr={fieldForm:{},fieldToEdit:"",initialData:{},modifiedData:{}},Qv=(e=Yr,t)=>(0,qt.default)(e,n=>{const s=["modifiedData","layouts","list"];switch(t.type){case"ADD_FIELD":{const a=T()(e,s,[]);re()(n,s,[...a,t.item]);break}case"MOVE_FIELD":{const a=T()(e,s,[]),{originalIndex:l,atIndex:i}=t;re()(n,s,vt(a,l,i));break}case"ON_CHANGE":{re()(n,["modifiedData",...t.keys.split(".")],t.value);break}case"ON_CHANGE_FIELD_METAS":{re()(n,["fieldForm",t.name],t.value);break}case"REMOVE_FIELD":{const a=T()(e,s,[]);re()(n,s,a.filter((l,i)=>t.index!==i));break}case"SET_FIELD_TO_EDIT":{const{fieldToEdit:a}=t;n.fieldToEdit=a,n.fieldForm.label=T()(n,["modifiedData","metadatas",a,"list","label"],""),n.fieldForm.sortable=T()(n,["modifiedData","metadatas",a,"list","sortable"],"");break}case"UNSET_FIELD_TO_EDIT":{n.fieldForm={},n.fieldToEdit="";break}case"SUBMIT_FIELD_FORM":{const a=["modifiedData","metadatas",e.fieldToEdit,"list"];re()(n,[...a,"label"],e.fieldForm.label),re()(n,[...a,"sortable"],e.fieldForm.sortable);break}default:return n}}),Kv=["media","richtext","dynamiczone","relation","component","json"];var Yv=(e,t,n)=>new Promise((s,a)=>{var l=c=>{try{u(n.next(c))}catch(d){a(d)}},i=c=>{try{u(n.throw(c))}catch(d){a(d)}},u=c=>c.done?s(c.value):Promise.resolve(c.value).then(l,i);u((n=n.apply(e,t)).next())});const rc=({layout:e,slug:t})=>{const{formatMessage:n}=(0,A.useIntl)(),{trackUsage:s}=(0,g.useTracking)(),a=Qo(),l=(0,g.useNotification)(),{refetchData:i}=(0,r.useContext)(uo),[u,c]=(0,r.useState)(!1),d=()=>c(S=>!S),[m,f]=(0,r.useState)(!1),y=()=>f(S=>!S),[h,b]=(0,r.useReducer)(Qv,Yr,()=>Zv(Yr,e)),{fieldToEdit:E,fieldForm:F,initialData:C,modifiedData:P}=h,{attributes:I}=e,R=P.layouts.list,z=()=>{const{settings:{pageSize:S,defaultSortBy:O,defaultSortOrder:_},kind:K,uid:ae}=C,ce=`${O}:${_}`,Fe=`${(0,Ne.stringify)({page:1,pageSize:S,sort:ce},{encode:!1})}${a?`&${a}`:""}`;return`/content-manager/${K}/${ae}?${Fe}`},M=({target:{name:S,value:O}})=>{b({type:"ON_CHANGE",keys:S,value:S==="settings.pageSize"?parseInt(O,10):O})},V=()=>Yv(void 0,null,function*(){const S=Ii()(P,["layouts","settings","metadatas"]);W.mutate(S)}),B=S=>{b({type:"ADD_FIELD",item:S})},G=(S,O)=>{S.stopPropagation(),R.length===1?l({type:"info",message:{id:v("notification.info.minimumFields")}}):b({type:"REMOVE_FIELD",index:O})},U=S=>{S.preventDefault(),d(),s("willSaveContentTypeLayout")},q=S=>{b({type:"SET_FIELD_TO_EDIT",fieldToEdit:S}),y()},x=()=>{b({type:"UNSET_FIELD_TO_EDIT"}),y()},Z=S=>{S.preventDefault(),y(),b({type:"SUBMIT_FIELD_FORM"})},W=(0,Tr.useMutation)(S=>Sv(S,t),{onSuccess(){s("didEditListSettings"),i()},onError(){l({type:"warning",message:{id:"notification.error"}})}}),{isLoading:X}=W,w=({target:{name:S,value:O}})=>{b({type:"ON_CHANGE_FIELD_METAS",name:S,value:O})},$=Object.entries(I).reduce((S,O)=>{const[_,K]=O,ae=yo(K),ce=R.includes(_);return ae&&!ce&&S.push(_),S},[]).sort(),Y=Object.entries(I).reduce((S,O)=>{const[_,{type:K}]=O;return Kv.includes(K)||S.push(_),S},[]),Q=(S,O)=>{b({type:"MOVE_FIELD",originalIndex:S,atIndex:O})};return r.createElement(ee.Layout,null,r.createElement(oe.Main,{"aria-busy":X},r.createElement("form",{onSubmit:U},r.createElement(ee.HeaderLayout,{navigationAction:r.createElement(g.Link,{startIcon:r.createElement(rn(),null),to:z,id:"go-back"},n({id:"global.back",defaultMessage:"Back"})),primaryAction:r.createElement(ye.Button,{size:"S",startIcon:r.createElement(ft(),null),disabled:Xt()(P,C),type:"submit"},n({id:"global.save",defaultMessage:"Save"})),subtitle:n({id:v("components.SettingsViewWrapper.pluginHeader.description.list-settings"),defaultMessage:"Define the settings of the list view."}),title:n({id:v("components.SettingsViewWrapper.pluginHeader.title"),defaultMessage:"Configure the view - {name}"},{name:It()(P.info.displayName)})}),r.createElement(ee.ContentLayout,null,r.createElement(D.Box,{background:"neutral0",hasRadius:!0,shadow:"tableShadow",paddingTop:6,paddingBottom:6,paddingLeft:7,paddingRight:7},r.createElement(Lv,{modifiedData:P,onChange:M,sortOptions:Y}),r.createElement(D.Box,{paddingTop:6,paddingBottom:6},r.createElement(Ut.Divider,null)),r.createElement(Bv,{listRemainingFields:$,displayedFields:R,onAddField:B,onClickEditField:q,onMoveField:Q,onRemoveField:G,metadatas:P.metadatas}))),r.createElement(g.ConfirmDialog,{bodyText:{id:v("popUpWarning.warning.updateAllSettings"),defaultMessage:"This will modify all your settings"},iconRightButton:r.createElement(ft(),null),isConfirmButtonLoading:X,isOpen:u,onToggleDialog:d,onConfirm:V,variantRightButton:"success-light"})),m&&r.createElement(Vv,{attributes:I,fieldForm:F,fieldToEdit:E,onChangeEditLabel:w,onCloseModal:x,onSubmit:Z,type:T()(I,[E,"type"],"text")})))};rc.propTypes={layout:o().shape({uid:o().string.isRequired,settings:o().shape({bulkable:o().bool,defaultSortBy:o().string,defaultSortOrder:o().string,filterable:o().bool,pageSize:o().number,searchable:o().bool}).isRequired,metadatas:o().object.isRequired,options:o().object.isRequired,attributes:o().objectOf(o().shape({type:o().string})).isRequired}).isRequired,slug:o().string.isRequired};const Jv=(0,r.memo)(rc),oc=De.Z.contentManager,sc=({match:{params:{slug:e},url:t}})=>{const{isLoading:n,layout:s,updateLayout:a}=zo(e),{rawContentTypeLayout:l,rawComponentsLayouts:i}=(0,r.useMemo)(()=>{let m={},f={};return s.contentType&&(m=Nt(s.contentType)),s.components&&(f=Object.keys(s.components).reduce((y,h)=>(y[h]=Nt(s.components[h]),y),{})),{rawContentTypeLayout:m,rawComponentsLayouts:f}},[s]);if((0,N.get)(s,["contentType","uid"],null)!==e||n)return r.createElement(g.LoadingIndicatorPage,null);const c=({location:{state:m},history:{goBack:f},match:{params:{id:y,origin:h}}},b)=>r.createElement(b,{slug:e,layout:s,state:m,goBack:f,id:y,origin:h}),d=[{path:"create/clone/:origin",comp:sn},{path:"create",comp:sn},{path:":id",comp:sn},{path:"",comp:Dv}].map(({path:m,comp:f})=>r.createElement(te.Route,{key:m,path:`${t}/${m}`,render:y=>c(y,f)}));return r.createElement(Lc.SV,{FallbackComponent:g.ErrorFallback},r.createElement(po.Provider,{value:s},r.createElement(te.Switch,null,r.createElement(te.Route,{path:`${t}/configurations/list`},r.createElement(g.CheckPagePermissions,{permissions:oc.collectionTypesConfigurations},r.createElement(Jv,{layout:l,slug:e,updateLayout:a}))),r.createElement(te.Route,{path:`${t}/configurations/edit`},r.createElement(g.CheckPagePermissions,{permissions:oc.collectionTypesConfigurations},r.createElement(Nr,{components:i,isContentTypeView:!0,mainLayout:l,slug:e,updateLayout:a}))),d)))};sc.propTypes={match:o().shape({url:o().string.isRequired,params:o().shape({slug:o().string.isRequired}).isRequired}).isRequired};const Xv=(0,r.memo)(sc);var ac=p(57678),eC=p(98399),tC=(e,t,n)=>new Promise((s,a)=>{var l=c=>{try{u(n.next(c))}catch(d){a(d)}},i=c=>{try{u(n.throw(c))}catch(d){a(d)}},u=c=>c.done?s(c.value):Promise.resolve(c.value).then(l,i);u((n=n.apply(e,t)).next())});const nC=De.Z.contentManager,rC=()=>{const[{isLoading:e,data:t},n]=(0,r.useReducer)(ac.Z,ac.q),s=(0,r.useMemo)(Rn,[]),{schemas:a}=(0,fe.useSelector)(i=>s(i),fe.shallowEqual),{uid:l}=(0,te.useParams)();return(0,r.useEffect)(()=>{const u=xe().CancelToken.source();return(d=>tC(void 0,null,function*(){try{n(Jt());const{data:{data:m}}=yield ge.be.get(ve(`components/${l}/configuration`),{cancelToken:d.token});n(gr(Io(m,a,"component")))}catch(m){if(xe().isCancel(m))return;eC.error(m)}}))(u),()=>{u.cancel("Operation canceled by the user.")}},[l,a]),e?r.createElement(g.LoadingIndicatorPage,null):r.createElement(g.CheckPagePermissions,{permissions:nC.componentsConfigurations},r.createElement(Nr,{components:t.components,mainLayout:t.component,slug:l}))},oC=(0,r.memo)(rC);var sC=p(64354),aC=p(97042),iC=p.n(aC);const lC=()=>{const{formatMessage:e}=(0,A.useIntl)();return(0,g.useFocusWhenNavigate)(),r.createElement(oe.Main,null,r.createElement(ee.HeaderLayout,{title:e({id:v("header.name"),defaultMessage:"Content"})}),r.createElement(ee.ContentLayout,null,r.createElement(sC.EmptyStateLayout,{action:r.createElement(g.LinkButton,{variant:"secondary",startIcon:r.createElement(ut(),null),to:"/plugins/content-type-builder/content-types/create-content-type"},e({id:"app.components.HomePage.create",defaultMessage:"Create your first Content-type"})),content:e({id:"content-manager.pages.NoContentType.text",defaultMessage:"You don't have any content yet, we recommend you to create your first Content-Type."}),hasRadius:!0,icon:r.createElement(iC(),{width:"10rem"}),shadow:"tableShadow"})))},cC=()=>{const{formatMessage:e}=(0,A.useIntl)();return(0,g.useFocusWhenNavigate)(),r.createElement(oe.Main,null,r.createElement(ee.HeaderLayout,{title:e({id:v("header.name"),defaultMessage:"Content"})}),r.createElement(ee.ContentLayout,null,r.createElement(g.NoPermissions,null)))},uC=De.Z.contentManager,ic=({match:{params:{slug:e},url:t}})=>{const{isLoading:n,layout:s,updateLayout:a}=zo(e),{rawContentTypeLayout:l,rawComponentsLayouts:i}=(0,r.useMemo)(()=>{let u={},c={};return s.contentType&&(c=Nt(s.contentType)),s.components&&(u=Object.keys(s.components).reduce((d,m)=>(d[m]=Nt(s.components[m]),d),{})),{rawContentTypeLayout:c,rawComponentsLayouts:u}},[s]);return n?r.createElement(g.LoadingIndicatorPage,null):r.createElement(po.Provider,{value:s},r.createElement(te.Switch,null,r.createElement(te.Route,{path:`${t}/configurations/edit`},r.createElement(g.CheckPagePermissions,{permissions:uC.singleTypesConfigurations},r.createElement(Nr,{components:i,isContentTypeView:!0,mainLayout:l,slug:e,updateLayout:a}))),r.createElement(te.Route,{path:t,render:({location:{state:u},history:{goBack:c}})=>r.createElement(sn,{layout:s,slug:e,isSingleType:!0,state:u,goBack:c})})))};ic.propTypes={match:o().shape({url:o().string.isRequired,params:o().shape({slug:o().string.isRequired}).isRequired}).isRequired};const dC=(0,r.memo)(ic);var pC=p(58469),mC=p(59578),lc=p.n(mC),kt=p(89420),fC=Object.defineProperty,gC=Object.defineProperties,yC=Object.getOwnPropertyDescriptors,cc=Object.getOwnPropertySymbols,hC=Object.prototype.hasOwnProperty,bC=Object.prototype.propertyIsEnumerable,uc=(e,t,n)=>t in e?fC(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,EC=(e,t)=>{for(var n in t||(t={}))hC.call(t,n)&&uc(e,n,t[n]);if(cc)for(var n of cc(t))bC.call(t,n)&&uc(e,n,t[n]);return e},vC=(e,t)=>gC(e,yC(t));const dc=(e,t)=>(0,pC.ZP)(e,lc()(t),{keys:[n=>lc()(n.title)]}),CC=()=>{const[e,t]=(0,r.useState)(""),{formatMessage:n}=(0,A.useIntl)(),s=(0,r.useMemo)(wu,[]),{collectionTypeLinks:a,singleTypeLinks:l}=(0,fe.useSelector)(h=>s(h),fe.shallowEqual),i=h=>h.map(b=>vC(EC({},b),{title:n({id:b.title,defaultMessage:b.title})})),u=i(a),c=i(l),d=[{id:"collectionTypes",title:{id:v("components.LeftMenu.collection-types"),defaultMessage:"Collection Types"},searchable:!0,links:ie()(dc(u,e),h=>h.title.toLowerCase())},{id:"singleTypes",title:{id:v("components.LeftMenu.single-types"),defaultMessage:"Single Types"},searchable:!0,links:ie()(dc(c,e),h=>h.title.toLowerCase())}],m=()=>{t("")},f=({target:{value:h}})=>{t(h)},y=n({id:v("header.name"),defaultMessage:"Content"});return r.createElement(kt.SubNav,{ariaLabel:y},r.createElement(kt.SubNavHeader,{label:y,searchable:!0,value:e,onChange:f,onClear:m,searchLabel:n({id:"content-manager.components.LeftMenu.Search.label",defaultMessage:"Search for a content type"})}),r.createElement(kt.SubNavSections,null,d.map(h=>{const b=n({id:h.title.id,defaultMessage:h.title.defaultMessage},h.title.values);return r.createElement(kt.SubNavSection,{key:h.id,label:b,badgeLabel:h.links.length.toString()},h.links.map(E=>{const F=E.search?`?${E.search}`:"";return r.createElement(kt.SubNavLink,{as:te.NavLink,key:E.uid,to:`${E.to}${F}`},E.title)}))})))};var Jr=p(92886);const PC=()=>({type:Jr.ZA}),OC=()=>({type:Jr.c2}),RC=(e,t,n,s)=>({type:Jr.ix,data:{authorizedCtLinks:e,authorizedStLinks:t,components:s,contentTypeSchemas:n}}),pc=(e,t,n=[])=>e.filter(s=>s.isDisplayed).map(s=>{const a=[{action:"plugin::content-manager.explorer.create",subject:s.uid},{action:"plugin::content-manager.explorer.read",subject:s.uid}],l=[{action:"plugin::content-manager.explorer.read",subject:s.uid}],i=t==="collectionTypes"?a:l,u=n.find(({uid:d})=>d===s.uid);let c=null;if(u){const d={page:1,pageSize:u.settings.pageSize,sort:`${u.settings.defaultSortBy}:${u.settings.defaultSortOrder}`};c=(0,Ne.stringify)(d,{encode:!1})}return{permissions:i,search:c,kind:s.kind,title:s.info.displayName,to:`/content-manager/${s.kind}/${s.uid}`,uid:s.uid,name:s.uid,isDisplayed:s.isDisplayed}}),MC=(e,t)=>{const[n,s]=(0,N.chain)(e).groupBy("kind").map((a,l)=>({name:l,links:a})).sortBy("name").value();return{collectionTypesSectionLinks:pc((0,N.get)(n,"links",[]),"collectionTypes",t),singleTypesSectionLinks:pc((0,N.get)(s,"links",[]),"singleTypes")}},mc=(e,t)=>t.map(({permissions:n})=>(0,g.hasPermissions)(e,n));var TC=p(98399),wC=(e,t,n)=>new Promise((s,a)=>{var l=c=>{try{u(n.next(c))}catch(d){a(d)}},i=c=>{try{u(n.throw(c))}catch(d){a(d)}},u=c=>c.done?s(c.value):Promise.resolve(c.value).then(l,i);u((n=n.apply(e,t)).next())});const IC=(e,t,n)=>wC(void 0,null,function*(){try{const{data:{data:s}}=yield ge.be.get(ve("content-types-settings")),{collectionTypesSectionLinks:a,singleTypesSectionLinks:l}=MC(e,s),i=mc(t,a),u=yield Promise.all(i),c=a.filter((y,h)=>u[h]),d=mc(t,l),m=yield Promise.all(d),f=l.filter((y,h)=>m[h]);return{authorizedCtLinks:c,authorizedStLinks:f}}catch(s){return TC.error(s),n({type:"warning",message:{id:"notification.error"}}),{authorizedCtLinks:[],authorizedStLinks:[],contentTypes:[]}}});var DC=p(98399),SC=Object.defineProperty,xC=Object.defineProperties,LC=Object.getOwnPropertyDescriptors,fc=Object.getOwnPropertySymbols,FC=Object.prototype.hasOwnProperty,kC=Object.prototype.propertyIsEnumerable,gc=(e,t,n)=>t in e?SC(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,AC=(e,t)=>{for(var n in t||(t={}))FC.call(t,n)&&gc(e,n,t[n]);if(fc)for(var n of fc(t))kC.call(t,n)&&gc(e,n,t[n]);return e},jC=(e,t)=>xC(e,LC(t)),$C=(e,t,n)=>new Promise((s,a)=>{var l=c=>{try{u(n.next(c))}catch(d){a(d)}},i=c=>{try{u(n.throw(c))}catch(d){a(d)}},u=c=>c.done?s(c.value):Promise.resolve(c.value).then(l,i);u((n=n.apply(e,t)).next())});const BC=()=>{const e=(0,fe.useDispatch)(),t=(0,g.useNotification)(),n=(0,fe.useSelector)(Rt()),s=(0,r.useRef)(),{allPermissions:a}=(0,g.useRBACProvider)(),{runHookWaterfall:l}=(0,g.useStrapiApp)(),u=xe().CancelToken.source(),{notifyStatus:c}=(0,qr.useNotifyAT)(),{formatMessage:d}=(0,A.useIntl)(),m=()=>$C(void 0,null,function*(){e(PC());try{const[{data:{data:f}},{data:{data:y}}]=yield Promise.all(["components","content-types"].map(P=>ge.be.get(ve(P),{cancelToken:u.token})));c(d({id:v("App.schemas.data-loaded"),defaultMessage:"The schemas have been successfully loaded."}));const{authorizedCtLinks:h,authorizedStLinks:b}=yield IC(y,a,t),{ctLinks:E}=l(zt.LK,{ctLinks:h,models:y}),{stLinks:F}=l(zt.dV,{stLinks:b,models:y}),C=RC(E,F,y,f);e(C)}catch(f){if(xe().isCancel(f))return;DC.error(f),t({type:"warning",message:{id:"notification.error"}})}});return s.current=m,(0,r.useEffect)(()=>(s.current(),()=>{u.cancel("Operation canceled by the user."),e(OC())}),[e,t]),jC(AC({},n),{refetchData:s.current})},NC=De.Z.contentManager,yc=()=>{const e=(0,te.useRouteMatch)("/content-manager/:kind/:uid"),{status:t,collectionTypeLinks:n,singleTypeLinks:s,models:a,refetchData:l}=BC(),i=ie()([...n,...s],y=>y.title.toLowerCase()),{pathname:u}=(0,te.useLocation)(),{formatMessage:c}=(0,A.useIntl)(),{startSection:d}=(0,g.useGuidedTour)(),m=(0,r.useRef)(d);if((0,r.useEffect)(()=>{m.current&&m.current("contentManager")},[]),t==="loading")return r.createElement(oe.Main,{"aria-busy":"true"},r.createElement(ee.HeaderLayout,{title:c({id:v("header.name"),defaultMessage:"Content"})}),r.createElement(g.LoadingIndicatorPage,null));const f=a.filter(({isDisplayed:y})=>y);return i.length===0&&f.length>0&&u!=="/content-manager/403"?r.createElement(te.Redirect,{to:"/content-manager/403"}):f.length===0&&u!=="/content-manager/no-content-types"?r.createElement(te.Redirect,{to:"/content-manager/no-content-types"}):!e&&i.length>0?r.createElement(te.Redirect,{to:`${i[0].to}${i[0].search?`?${i[0].search}`:""}`}):r.createElement(ee.Layout,{sideNav:r.createElement(CC,null)},r.createElement(xc,null),r.createElement(uo.Provider,{value:{refetchData:l}},r.createElement(te.Switch,null,r.createElement(te.Route,{path:"/content-manager/components/:uid/configurations/edit"},r.createElement(g.CheckPagePermissions,{permissions:NC.componentsConfigurations},r.createElement(oC,null))),r.createElement(te.Route,{path:"/content-manager/collectionType/:slug",component:Xv}),r.createElement(te.Route,{path:"/content-manager/singleType/:slug",component:dC}),r.createElement(te.Route,{path:"/content-manager/403"},r.createElement(cC,null)),r.createElement(te.Route,{path:"/content-manager/no-content-types"},r.createElement(lC,null)),r.createElement(te.Route,{path:"",component:g.NotFound}))))};function VC(){const{formatMessage:e}=(0,A.useIntl)();return r.createElement(r.Fragment,null,r.createElement(at.Helmet,{title:e({id:v("plugin.name"),defaultMessage:"Content Manager"})}),r.createElement(yc,null))}},57544:()=>{},59599:()=>{},42310:()=>{},33842:()=>{},85695:()=>{}}]);
